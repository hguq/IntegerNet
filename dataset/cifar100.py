...
def get_cifar100(dataset_path, batch_size):
    ...
    """
    train_set = CIFAR100(dataset_path + "cifar100", train=True, transform=cifar_train_transform)
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=False, num_workers=4)

    test_set = CIFAR100(dataset_path + "cifar100", train=False, transform=cifar_test_transform)
